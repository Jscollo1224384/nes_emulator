...
/** LDA Indirect X tests *******************************************************************/
void test_LDA_indirect_x_loads_accumulator(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
...
void test_LDA_indirect_x_sets_zero_flag(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
...
void test_LDA_indirect_x_sets_negative_flag(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
...
void test_LDA_indirect_x_clears_zero_flag(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
...
void test_LDA_indirect_x_clears_negative_flag(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
...
void test_LDA_indirect_x_returns_six_cycles(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
...
void test_LDA_indirect_x_wraps_around_zero_page(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
...
/** LDA Indirect Y tests *******************************************************************/
void test_LDA_indirect_y_loads_accumulator(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
...
void test_LDA_indirect_y_sets_zero_flag(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
...
void test_LDA_indirect_y_sets_negative_flag(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
...
void test_LDA_indirect_y_clears_zero_flag(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
...
void test_LDA_indirect_y_clears_negative_flag(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
...
void test_LDA_indirect_y_returns_five_cycles(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
...
void test_LDA_indirect_y_returns_six_cycles_on_page_cross(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
    ...
    mem[0x0020] = 0xFF;
    mem[0x0021] = 0x30;
    mem[0x3103] = 0x42; // 0x30FF + 0x04 = 0x3103, crosses page boundary
...
void test_LDA_indirect_y_wraps_zero_page_pointer(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
    ...
    mem[0x8001] = 0xFF;
    mem[0x00FF] = 0x00;
    mem[0x0000] = 0x30; // hi byte wraps to 0x0000
    mem[0x3004] = 0x42;
...
void test_PLP_pulls_processor_status_from_stack(void) {
    ...
    TEST_ASSERT_BITS(FLAG_I, 0b00000100, cpu.P);
    TEST_ASSERT_BITS(FLAG_N, 0b00000000, cpu.P);
}
...
void test_AND_absolute_y_sets_zero_flag(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
...
void test_AND_absolute_y_returns_five_cycles_on_page_cross(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
...
/** AND Indirect X Tests ****************************************************************************************/
void test_AND_indirect_x_ands_accumulator_with_indexed_indirect_value(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
...
void test_AND_indirect_x_sets_zero_flag(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
...
/** AND Indirect Y Tests ****************************************************************************************/
void test_AND_indirect_y_ands_accumulator_with_indirect_y_offset_value(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
...
void test_AND_indirect_y_sets_zero_flag(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
...
void test_AND_indirect_y_returns_six_cycles_on_page_cross(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
...
/**ORA Immediate Tests *****************************************************************************************/
void test_ORA_immediate_performs_or_operation(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
...
void test_ORA_immediate_sets_zero_flag(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
...
/** ORA Zero Page Tests *************************************************************************************************/
void test_ORA_zeropage_performs_or_operation(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
...
void test_ORA_zeropage_sets_zero_flag(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
...
/** ORA Zero Page X Tests **************************************************************************************/
void test_ORA_zeropage_x_ors_accumulator_with_x_offset_value(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
...
void test_ORA_zeropage_x_sets_zero_flag(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
...
void test_ORA_zeropage_x_clears_zero_flag(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
...
void test_ORA_zeropage_x_wraps_around_zero_page(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
    ...
    TEST_ASSERT_EQUAL(0b00000001, cpu.A);
}

/** ORA Absolute Tests ***********************************************************************************/
void test_ORA_absolute_performs_or_operation(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
...
void test_ORA_absolute_sets_zero_flag(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
...
void test_ORA_absolute_x_ors_accumulator_with_x_offset_value(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
    mem[0xFFFC] = 0x00;
...
void test_ORA_absolute_x_sets_zero_flag(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
    mem[0xFFFC] = 0x00;
...
void test_ORA_absolute_x_returns_five_cycles_on_page_cross(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
    mem[0xFFFC] = 0x00;
...
void test_ORA_absolute_y_ors_accumulator_with_y_offset_value(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
...
void test_ORA_absolute_y_sets_zero_flag(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
...
void test_ORA_absolute_y_returns_five_cycles_on_page_cross(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
...
/** ORA Indirect Tests *************************************************************************************************/
void test_ORA_indirect_x_ors_accumulator_with_indexed_indirect_value(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
...
void test_ORA_indirect_x_sets_zero_flag(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
...
/** ORA Indirect Y Tests *************************************************************************************************/
void test_ORA_indirect_y_ors_accumulator_with_indirect_y_offset_value(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
...
void test_ORA_indirect_y_sets_zero_flag(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
...
void test_ORA_indirect_y_sets_negative_flag(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
...
void test_ORA_indirect_y_clears_zero_flag(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
...
void test_ORA_indirect_y_clears_negative_flag(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
...
void test_ORA_indirect_y_returns_five_cycles(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
...
void test_ORA_indirect_y_returns_six_cycles_on_page_cross(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
    ...
    mem[0x0000] = 0xFF;
    mem[0x0001] = 0x20;
    mem[0x2104] = 0b00000001; //0x01 — 0x20FF + 0x05 = 0x2104, crosses page boundary
...
/** EOR Zero Page Tests *************************************************************************************************/
void test_EOR_zero_page_performs_eor_operation(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
...
void test_EOR_zero_page_sets_zero_flag(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
...
void test_EOR_zero_page_sets_negative_flag(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
...
void test_EOR_zero_page_clears_zero_flag(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
...
void test_EOR_zero_page_clears_negative_flag(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
...
void test_EOR_zero_page_returns_three_cycles(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
...
/** EOR Zero Page X Tests *************************************************************************************************/
void test_EOR_zero_page_x_performs_eor_operation(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
...
void test_EOR_zero_page_x_sets_zero_flag(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
...
void test_EOR_zero_page_x_sets_negative_flag(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
...
void test_EOR_zero_page_x_clears_zero_flag(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
...
void test_EOR_zero_page_x_clears_negative_flag(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
...
void test_EOR_zero_page_x_returns_four_cycles(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
...
/** EOR Absolut X tests ************************************************************************************************/
void test_EOR_absolute_x_eors_accumulator_with_x_offset_value(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
    mem[0xFFFC] = 0x00;
...
/** EOR Absolute Y Tests *******************************************************************************************/
void test_EOR_absolute_y_eors_accumulator_with_y_offset_value(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
    mem[0xFFFC] = 0x00;
...
void test_EOR_absolute_y_sets_zero_flag(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
    mem[0xFFFC] = 0x00;
...
void test_EOR_absolute_y_sets_negative_flag(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
    mem[0xFFFC] = 0x00;
...
void test_EOR_absolute_y_clears_zero_flag(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
    mem[0xFFFC] = 0x00;
...
void test_EOR_absolute_y_clears_negative_flag(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
    mem[0xFFFC] = 0x00;
...
void test_EOR_absolute_y_returns_four_cycles(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
    mem[0xFFFC] = 0x00;
...
/** EOR Indirect X Tests *******************************************************************************************/
void test_EOR_absolute_y_returns_five_cycles_when_page_crossed(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
    mem[0xFFFC] = 0x00;
...
void test_EOR_indirect_x_eors_accumulator_with_indexed_indirect_value(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
...
void test_EOR_indirect_x_sets_zero_flag(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
...
void test_EOR_indirect_x_sets_negative_flag(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
...
void test_EOR_indirect_x_clears_zero_flag(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
...
void test_EOR_indirect_x_clears_negative_flag(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
...
void test_EOR_indirect_x_returns_six_cycles(void)
{
    CPU cpu;
    uint8_t mem[0x10000] = {0};
...
int main(void) {
    ...
    //Indirect X
    RUN_TEST(test_LDA_indirect_x_loads_accumulator);
    RUN_TEST(test_LDA_indirect_x_sets_zero_flag);
    RUN_TEST(test_LDA_indirect_x_sets_negative_flag);
    RUN_TEST(test_LDA_indirect_x_clears_zero_flag);
    RUN_TEST(test_LDA_indirect_x_clears_negative_flag);
    RUN_TEST(test_LDA_indirect_x_returns_six_cycles);
    RUN_TEST(test_LDA_indirect_x_wraps_around_zero_page);

    //Indirect Y
    RUN_TEST(test_LDA_indirect_y_loads_accumulator);
    RUN_TEST(test_LDA_indirect_y_sets_zero_flag);
    RUN_TEST(test_LDA_indirect_y_sets_negative_flag);
    RUN_TEST(test_LDA_indirect_y_clears_zero_flag);
    RUN_TEST(test_LDA_indirect_y_clears_negative_flag);
    RUN_TEST(test_LDA_indirect_y_returns_five_cycles);
    RUN_TEST(test_LDA_indirect_y_returns_six_cycles_on_page_cross);
    RUN_TEST(test_LDA_indirect_y_wraps_zero_page_pointer);
    ...
    RUN_TEST(test_AND_absolute_y_sets_zero_flag);
    RUN_TEST(test_AND_absolute_y_sets_negative_flag);
    RUN_TEST(test_AND_absolute_y_clears_zero_flag);
    RUN_TEST(test_AND_absolute_y_clears_negative_flag);
    RUN_TEST(test_AND_absolute_y_returns_four_cycles);
    RUN_TEST(test_AND_absolute_y_returns_five_cycles_on_page_cross);

    //Indirect X
    RUN_TEST(test_AND_indirect_x_ands_accumulator_with_indexed_indirect_value);
    RUN_TEST(test_AND_indirect_x_sets_zero_flag);
    RUN_TEST(test_AND_indirect_x_sets_negative_flag);
    RUN_TEST(test_AND_indirect_x_clears_zero_flag);
    RUN_TEST(test_AND_indirect_x_clears_negative_flag);
    RUN_TEST(test_AND_indirect_x_returns_six_cycles);

    //Indirect Y
    RUN_TEST(test_AND_indirect_y_ands_accumulator_with_indirect_y_offset_value);
    RUN_TEST(test_AND_indirect_y_sets_zero_flag);
    RUN_TEST(test_AND_indirect_y_sets_negative_flag);
    RUN_TEST(test_AND_indirect_y_clears_zero_flag);
    RUN_TEST(test_AND_indirect_y_clears_negative_flag);
    RUN_TEST(test_AND_indirect_y_returns_five_cycles);
    RUN_TEST(test_AND_indirect_y_returns_six_cycles_on_page_cross);

    //ORA Tests
    //Addressing modes
    //Immediate
    RUN_TEST(test_ORA_immediate_performs_or_operation);
    RUN_TEST(test_ORA_immediate_sets_zero_flag);
    RUN_TEST(test_ORA_immediate_sets_negative_flag);
    RUN_TEST(test_ORA_immediate_clears_zero_flag);
    RUN_TEST(test_ORA_immediate_clears_negative_flag);
    RUN_TEST(test_ORA_immediate_returns_two_cycles);

    //Zero page
    RUN_TEST(test_ORA_zeropage_performs_or_operation);
    RUN_TEST(test_ORA_zeropage_sets_zero_flag);
    RUN_TEST(test_ORA_zeropage_sets_negative_flag);
    RUN_TEST(test_ORA_zeropage_clears_zero_flag);
    RUN_TEST(test_ORA_zeropage_clears_negative_flag);
    RUN_TEST(test_ORA_zeropage_returns_three_cycles);

    //Zero page x
    RUN_TEST(test_ORA_zeropage_x_ors_accumulator_with_x_offset_value);
    RUN_TEST(test_ORA_zeropage_x_sets_zero_flag);
    RUN_TEST(test_ORA_zeropage_x_sets_negative_flag);
    RUN_TEST(test_ORA_zeropage_x_clears_zero_flag);
    RUN_TEST(test_ORA_zeropage_x_clears_negative_flag);
    RUN_TEST(test_ORA_zeropage_x_returns_four_cycles);
    RUN_TEST(test_ORA_zeropage_x_wraps_around_zero_page);

    //Absolute
    RUN_TEST(test_ORA_absolute_performs_or_operation);
    RUN_TEST(test_ORA_absolute_sets_zero_flag);
    RUN_TEST(test_ORA_absolute_sets_negative_flag);
    RUN_TEST(test_ORA_absolute_clears_zero_flag);
    RUN_TEST(test_ORA_absolute_clears_negative_flag);
    RUN_TEST(test_ORA_absolute_returns_four_cycles);

    //Absolute X
    RUN_TEST(test_ORA_absolute_x_ors_accumulator_with_x_offset_value);
    RUN_TEST(test_ORA_absolute_x_sets_zero_flag);
    RUN_TEST(test_ORA_absolute_x_sets_negative_flag);
    RUN_TEST(test_ORA_absolute_x_clears_zero_flag);
    RUN_TEST(test_ORA_absolute_x_clears_negative_flag);
    RUN_TEST(test_ORA_absolute_x_returns_four_cycles);
    RUN_TEST(test_ORA_absolute_x_returns_five_cycles_on_page_cross);

    //Absolute Y
    RUN_TEST(test_ORA_absolute_y_ors_accumulator_with_y_offset_value);
    RUN_TEST(test_ORA_absolute_y_sets_zero_flag);
    RUN_TEST(test_ORA_absolute_y_sets_negative_flag);
    RUN_TEST(test_ORA_absolute_y_clears_zero_flag);
    RUN_TEST(test_ORA_absolute_y_clears_negative_flag);
    RUN_TEST(test_ORA_absolute_y_returns_four_cycles);
    RUN_TEST(test_ORA_absolute_y_returns_five_cycles_on_page_cross);

    //Indirect X
    RUN_TEST(test_ORA_indirect_x_ors_accumulator_with_indexed_indirect_value);
    RUN_TEST(test_ORA_indirect_x_sets_zero_flag);
    RUN_TEST(test_ORA_indirect_x_sets_negative_flag);
    RUN_TEST(test_ORA_indirect_x_clears_zero_flag);
    RUN_TEST(test_ORA_indirect_x_clears_negative_flag);
    RUN_TEST(test_ORA_indirect_x_returns_six_cycles);

    //Indirect Y
    RUN_TEST(test_ORA_indirect_y_ors_accumulator_with_indirect_y_offset_value);
    RUN_TEST(test_ORA_indirect_y_sets_zero_flag);
    RUN_TEST(test_ORA_indirect_y_sets_negative_flag);
    RUN_TEST(test_ORA_indirect_y_clears_zero_flag);
    ...
    //Zero-page
    RUN_TEST(test_EOR_zero_page_performs_eor_operation);
    RUN_TEST(test_EOR_zero_page_sets_zero_flag);
    RUN_TEST(test_EOR_zero_page_sets_negative_flag);
    RUN_TEST(test_EOR_zero_page_clears_zero_flag);
    RUN_TEST(test_EOR_zero_page_clears_negative_flag);
    RUN_TEST(test_EOR_zero_page_returns_three_cycles);

    //Zero-page X
    RUN_TEST(test_EOR_zero_page_x_performs_eor_operation);
    RUN_TEST(test_EOR_zero_page_x_sets_zero_flag);
    RUN_TEST(test_EOR_zero_page_x_sets_negative_flag);
    ...
    //Absolute X
    RUN_TEST(test_EOR_absolute_x_eors_accumulator_with_x_offset_value);
    ...
    //Absolute Y
    RUN_TEST(test_EOR_absolute_y_eors_accumulator_with_y_offset_value);
    RUN_TEST(test_EOR_absolute_y_sets_zero_flag);
    RUN_TEST(test_EOR_absolute_y_sets_negative_flag);
    RUN_TEST(test_EOR_absolute_y_clears_zero_flag);
    RUN_TEST(test_EOR_absolute_y_clears_negative_flag);
    RUN_TEST(test_EOR_absolute_y_returns_four_cycles);
    RUN_TEST(test_EOR_absolute_y_returns_five_cycles_when_page_crossed);

    //Indirect X
    RUN_TEST(test_EOR_indirect_x_eors_accumulator_with_indexed_indirect_value);
    RUN_TEST(test_EOR_indirect_x_sets_zero_flag);
    RUN_TEST(test_EOR_indirect_x_sets_negative_flag);
    RUN_TEST(test_EOR_indirect_x_clears_zero_flag);
    RUN_TEST(test_EOR_indirect_x_clears_negative_flag);
    RUN_TEST(test_EOR_indirect_x_returns_six_cycles);
    return UNITY_END();
}
